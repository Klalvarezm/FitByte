...
import com.core.models.plateIngredient;
...
public class plateIngredientDAO {
    ...
    public static final String CREATE_SQL = "INSERT INTO PLATO_INGREDIENTE (ID_PLATO_INGREDIENTE,PLATO_ID,DESCRIPCION, INGREDIENTE_ID) VALUES (?,?,?)";
    public static final String UPDATE_SQL = "UPDATE PLATO_INGREDIENTE SET DESCRIPCION = ?, CALORIAS_QUEMA_HORA = ? WHERE ID_PLATO_INGREDIENTE = ?";
    ...
    public static int update(plateIngredient plateingredient){       
        try (PreparedStatement statement = connection.prepareStatement(UPDATE_SQL)) {
                statement.setInt(1, plateingredient.getPlateIngredientID());
                statement.setInt(2, plateingredient.getPlateIngredientPlateID());
                statement.setInt(3, plateingredient.getPlateIngredientIngredientID());
